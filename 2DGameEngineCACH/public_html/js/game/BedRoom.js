...
class BedRoom extends Game
{
    ...
    constructor(canvasId)
    {
       ...
       this.addGameObject(new Background(0,0, 10000,this.canvas.height, Images.backgroud));
        ...
        let platforms = [
                new Platform(0, this.canvas.height-40,300, 20),
                new Platform(0, 90,300, 20),
                new Platform(300, 90,300, 20),
                new Platform(0, this.canvas.height, 300, 20),
        ];
        ...
        this.addGameObject(new HiddingSpots(200, this.canvas.height-40,80, 30, "Bed"));
